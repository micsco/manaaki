        ...
        {toasts.map(toast => (
          ...
          >
            <Toast.Content className="overflow-hidden transition-opacity duration-250 data-behind:pointer-events-none data-expanded:pointer-events-auto data-behind:opacity-0 data-expanded:opacity-100">
              ...
              {toast.actionProps && (
                <Toast.Action className="mt-3 inline-flex h-8 items-center justify-center rounded-lg bg-orange-600 px-3 font-medium text-sm text-white transition-colors hover:bg-orange-700 focus:outline-hidden focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-gray-900" />
              )}
              <Toast.Close
