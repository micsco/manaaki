            ...
            <li key={id}>
              {r?.slug ? (
                <a
                  ...
                  className="inline-block rounded-full bg-gray-800 px-3 py-1 text-sm text-gray-200 transition-colors hover:bg-gray-700"
                >
                  {r.name}
                </a>
              ) : (
                <span className="inline-block rounded-full bg-gray-800 px-3 py-1 text-sm text-gray-400">
                  {r?.name ?? "Recipe"}
                </span>
              )}
            </li>
