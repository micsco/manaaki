...
export function Badge({ children, variant = "tag", className = "" }: BadgeProps) {
  ...
  const variantClasses = {
    ...
    overlay: "bg-black/40 text-white backdrop-blur-xs border border-white/10",
    "overlay-highlight": "bg-orange-600/80 text-white backdrop-blur-xs border border-orange-500/50",
  }
